    ...
    try {
      ...
      const embed = EmbedFactory.leveling(`📊 <@${target.id}>'s Activity`)
        ...
        .addFields(
          ...
          { name: '🎤 Voice Minutes', value: Math.floor(activity.voiceMinutes).toLocaleString(), inline: true },
          { name: '👍 Reactions', value: activity.reactions.toLocaleString(), inline: true },
          { name: '📈 Activity Score', value: activity.activityScore.toLocaleString(), inline: true },
          { name: '⭐ Engagement Score', value: activity.engagementScore.toLocaleString(), inline: true },
          { name: '🔥 Streak', value: `${activity.streak} days`, inline: true },
          { name: '📊 Avg Messages/Day', value: avgMessagesPerDay, inline: true },
          { name: '🎤 Avg Voice/Day', value: `${avgVoicePerDay}m`, inline: true },
