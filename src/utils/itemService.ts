...
export function canUseInBattle(itemId: string): boolean {
...
export function getItemEffect(itemId: string) {
  const item = getItem(itemId);
...
export function formatItemDisplay(item: any, quantity: number = 1): string {
