 ...
 */
export async function addXP(userId: string, guildId: string, amount: number, multiplier: number = 1) {
 ...
 */
async function getAllUsers(guildId: string, dataType: 'levels' | 'users'): Promise<any[]> {
 ...
 */
export async function getEconomyLeaderboard(guildId: string, limit: number = 10) {
 ...
 */
export async function setXP(userId: string, guildId: string, xp: number) {
