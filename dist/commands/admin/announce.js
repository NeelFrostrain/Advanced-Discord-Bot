...
export default {
    data: new SlashCommandBuilder()
        ...
        .addChoices({ name: 'Blue', value: '#5865F2' }, { name: 'Green', value: '#00FF00' }, { name: 'Red', value: '#FF0000' }, { name: 'Gold', value: '#FFD700' }, { name: 'Purple', value: '#9B59B6' })
        .setRequired(false))
    ...
    async execute(interaction, client) {
        ...
        try {
            const embed = EmbedFactory.custom(color, `📢 ${title}`)
