...
export default {
    data: new SlashCommandBuilder()
        ...
        .addChoices({ name: '24 Hours', value: '1' }, { name: '7 Days', value: '7' }, { name: '30 Days', value: '30' }, { name: '90 Days', value: '90' })
        .setRequired(false)),
    async execute(interaction, client) {
        ...
        try {
            ...
            const embed = EmbedFactory.leveling(`📊 Server Statistics (${period}d)`)
                .addFields({ name: '💬 Total Messages', value: totalMessages.toLocaleString(), inline: true }, { name: '📈 Avg Messages/Day', value: Math.floor(totalMessages / period).toLocaleString(), inline: true }, { name: '📊 Growth Rate', value: `${serverHealth.growthRate}%`, inline: true }, { name: '👥 Joins', value: totalJoins.toString(), inline: true }, { name: '👋 Leaves', value: totalLeaves.toString(), inline: true }, { name: '📈 Net Growth', value: (totalJoins - totalLeaves).toString(), inline: true }, { name: '🎯 Activity Trend', value: serverHealth.activityTrend === 'increasing' ? '📈 Increasing' : '📉 Decreasing', inline: true }, { name: '⏰ Total Voice Minutes', value: serverAnalytics.totalVoiceMinutes.toLocaleString(), inline: true }, { name: '👤 Current Members', value: interaction.guild.memberCount.toString(), inline: true })
