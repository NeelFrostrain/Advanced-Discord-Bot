    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            const embed = EmbedFactory.success('Purchase Successful!')
                ...
                .addFields({ name: '💰 Remaining Balance', value: `${user.balance.toLocaleString()} coins`, inline: true }, { name: '📦 Item Type', value: item.type, inline: true }, { name: '✨ Rarity', value: `${rarityEmoji} ${item.rarity}`, inline: true });
            if (item.description) {
