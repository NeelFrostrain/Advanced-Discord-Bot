    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            const embed = EmbedFactory.leveling(`🎫 ${target.username}'s Invites`)
                ...
                .addFields({ name: '✅ Total Invites', value: stats.totalInvites.toString(), inline: true }, { name: '👥 Real Invites', value: stats.realInvites.toString(), inline: true }, { name: '🚫 Fake Invites', value: stats.fakeInvites.toString(), inline: true }, { name: '👋 Left Server', value: stats.leftInvites.toString(), inline: true }, { name: '🎁 Bonus Invites', value: stats.bonusInvites.toString(), inline: true }, { name: '💎 Valid Invites', value: totalValid.toString(), inline: true });
            if (stats.rank > 0) {
