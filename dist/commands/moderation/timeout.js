    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            const embed = EmbedFactory.moderation('User Timed Out')
                .addFields({ name: '👤 User', value: `${target.tag}`, inline: true }, { name: '⏰ Duration', value: duration, inline: true }, { name: '👮 Moderator', value: `${interaction.user.tag}`, inline: true }, { name: '📝 Reason', value: reason });
